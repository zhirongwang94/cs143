...
<!--Division of Recent Post-->
<div>
	<pre>Recent post:</pre>
	   <span style="color:grey;font-size:11px;"> 排序  </span>
       <a style="color:grey;font-size:10px;" href="notes-alphabet.html">字母</a></li>
       <a style="color:red;font-size:10px;" href="notes-time.html">时间</a></li>
</div>
